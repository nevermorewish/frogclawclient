...
[Releases](https://github.com/FrogClaw-Desktop/FrogClaw/releases) ページにアクセスして、お使いのプラットフォーム向けのインストーラーをダウンロードしてください。
...
- 「FrogClaw」は壊れているため開けません
- 悪意のあるソフトウェアがないか確認できないため、「FrogClaw」を開けません
