...
FrogClaw مساعد AI لسطح المكتب متكامل يجمع بين الدردشة متعددة المزودين وعرض المحتوى القوي وتكامل الأدوات وبوابة API مدمجة — يعمل كل شيء محلياً مع حماية قوية للبيانات.
...
- **روابط استيراد المزوّدين** — يمكن لمواقع المزوّدين أو لوحاتهم فتح FrogClaw عبر رابط `FrogClaw://` وملء الاسم و Base URL ومفتاح API ونوع المزوّد بعد تأكيد المستخدم. راجع [إعداد المزوّدين](./guide/providers).
...
يتضمن FrogClaw وضع Agent مدمج يمكّن الذكاء الاصطناعي من تنفيذ المهام متعددة الخطوات بشكل مستقل مع تحكم دقيق في الأذونات.
...
يتجاوز FrogClaw الدردشة النصية البسيطة بكثير مع خط أنابيب عرض غني وتفاعلي.
...
يتضمن FrogClaw خادم API محلي مدمجاً يحول تطبيق سطح المكتب إلى بوابة AI قوية.
...
تتيح لك البوابة استخدام FrogClaw كخلفية AI موحدة لجميع أدواتك. وجّه عملاء CLI وامتدادات IDE أو البرامج النصية المخصصة نحو البوابة المحلية واستفد من تدوير المفاتيح وتتبع الاستخدام والتحكم في الوصول.
:::

## البيانات والأمان

بياناتك لا تغادر جهازك أبداً. FrogClaw مُصمَّم مع الأمان المحلي أولاً في كل طبقة.
...
الملف `~/.frogclaw/master.key` هو جذر كل التشفير في FrogClaw. احتفظ به آمناً وأدرجه في نسخك الاحتياطية.
:::

## تجربة سطح المكتب

FrogClaw مبني كتطبيق سطح مكتب أصلي مع الصقل والتكامل المتوقعَين من أداة الاستخدام اليومي.
...
- **بدء تلقائي** — تشغيل FrogClaw اختيارياً عند بدء تشغيل النظام.
- **دعم الوكيل** — تكوين وكلاء HTTP وSOCKS5 للبيئات ذات الوصول المحدود للشبكة.
- **تحديثات تلقائية** — يتحقق FrogClaw تلقائياً من الإصدارات الجديدة عند الإطلاق.
