...
Laden Sie den neuesten Installer von der [Download-Seite](/de/download) oder [GitHub Releases](https://github.com/FrogClaw-Desktop/FrogClaw/releases) herunter.
...
1. Öffnen Sie die `.dmg` und ziehen Sie **FrogClaw** in den **Programme**-Ordner.
2. Starten Sie FrogClaw. Wenn macOS die App blockiert, gehen Sie zu **Systemeinstellungen → Datenschutz & Sicherheit** und klicken Sie auf **Trotzdem öffnen**.
...
| Architektur | Datei |
|-------------|-------|
| x64 (die meisten PCs) | `FrogClaw_x.x.x_x64-setup.exe` |
| ARM64 | `FrogClaw_x.x.x_arm64-setup.exe` |

Führen Sie den Installer aus und folgen Sie dem Assistenten. Starten Sie FrogClaw über das Startmenü oder die Desktop-Verknüpfung.
...
| Beliebige Distribution | x64 | `FrogClaw_x.x.x_amd64.AppImage` |
| Beliebige Distribution | ARM64 | `FrogClaw_x.x.x_aarch64.AppImage` |
...
Starten Sie FrogClaw und klicken Sie auf das **Zahnrad-Symbol** unten in der Seitenleiste, oder drücken Sie <kbd>Cmd/Ctrl</kbd>+<kbd>,</kbd>.
...
4. FrogClaw streamt die Antwort in Echtzeit. Modelle mit Denkblöcken (z.B. Claude, DeepSeek R1) zeigen den Reasoning-Prozess in einem einklappbaren Bereich.
