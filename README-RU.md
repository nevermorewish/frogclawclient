...
Перейдите на страницу [Releases](https://github.com/FrogClaw-Desktop/FrogClaw/releases) и загрузите установщик для вашей платформы.
...
- «FrogClaw» повреждён и не может быть открыт
- «FrogClaw» не может быть открыт, поскольку Apple не может проверить его на наличие вредоносного программного обеспечения
