...
[Releases](https://github.com/FrogClaw-Desktop/FrogClaw/releases) 페이지로 이동하여 플랫폼에 맞는 설치 프로그램을 다운로드하세요.
...
- "FrogClaw"이 손상되어 열 수 없습니다
- Apple에서 악성 소프트웨어를 확인할 수 없어 "FrogClaw"을 열 수 없습니다
