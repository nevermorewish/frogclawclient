...
توجه إلى صفحة [Releases](https://github.com/FrogClaw-Desktop/FrogClaw/releases) وقم بتنزيل المثبّت الخاص بمنصتك.
...
- «FrogClaw» تالف ولا يمكن فتحه
- لا يمكن فتح «FrogClaw» لأن Apple لا تستطيع التحقق منه بحثاً عن البرامج الضارة
